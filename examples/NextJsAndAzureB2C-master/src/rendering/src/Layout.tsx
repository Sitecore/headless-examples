  ...
  return (
    <div className="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom">
      ...
      <nav className="my-2 my-md-0 mr-md-3">
        ...
        {!session && <>
            <a href="#" onClick={handleSignIn} className="p-2 text-dark">Sign in</a>
          </>}
          {session && <>
            <b>Signed in as {session.user.name}</b> <a href="#" onClick={handleSignOut} className="p-2 text-dark">Sign out</a>
          </>}
      </nav>
    </div>
  );
