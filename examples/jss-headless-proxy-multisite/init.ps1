...
try {
    ...
    & $mkcert -install
    & $mkcert "*.jssheadlessproxymultisite.localhost"
...
Add-HostsEntry "cm.jssheadlessproxymultisite.localhost"
Add-HostsEntry "cd.jssheadlessproxymultisite.localhost"
Add-HostsEntry "id.jssheadlessproxymultisite.localhost"
Add-HostsEntry "site-one.jssheadlessproxymultisite.localhost"
Add-HostsEntry "site-two.jssheadlessproxymultisite.localhost"
Add-HostsEntry "site-two-b.jssheadlessproxymultisite.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.jssheadlessproxymultisite.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.jssheadlessproxymultisite.localhost"

    # SITES
    Set-EnvFileVariable "SITE_ONE_HOST" -Value "site-one.jssheadlessproxymultisite.localhost"
    Set-EnvFileVariable "SITE_TWO_HOST" -Value "site-two.jssheadlessproxymultisite.localhost"
    Set-EnvFileVariable "SITE_TWO_B_HOST" -Value "site-two-b.jssheadlessproxymultisite.localhost"
