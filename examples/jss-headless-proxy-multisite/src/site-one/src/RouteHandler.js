...
class RouteHandler extends React.Component {
  ...
  updateRouteData() {
    ...
    /**
     * MULTISITE-UPDATE
     * Read the current site name from context data, and maintain it during route changes.
     */
    const siteName = this.props.sitecoreContext ? this.props.sitecoreContext.site.name : null;

    // instantiate the dictionary service.
    const layoutServiceInstance = layoutServiceFactory.create(siteName);
