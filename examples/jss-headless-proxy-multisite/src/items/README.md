...
* `JssHeadlessProxyMultisite.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `JssHeadlessProxyMultisite-Content.module.json` contains content items which are
