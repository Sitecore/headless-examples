...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sitecore-embedded-jss-app.localhost"
}
catch {
...
Add-HostsEntry "cm.sitecore-embedded-jss-app.localhost"
Add-HostsEntry "cd.sitecore-embedded-jss-app.localhost"
Add-HostsEntry "id.sitecore-embedded-jss-app.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sitecore-embedded-jss-app.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sitecore-embedded-jss-app.localhost"
