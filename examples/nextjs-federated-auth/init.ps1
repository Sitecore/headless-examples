...
try {
    ...
    & $mkcert -install
    & $mkcert "*.nextjsandazureb2c.localhost"
...
Add-HostsEntry "cm.nextjsandazureb2c.localhost"
Add-HostsEntry "cd.nextjsandazureb2c.localhost"
Add-HostsEntry "id.nextjsandazureb2c.localhost"
Add-HostsEntry "www.nextjsandazureb2c.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.nextjsandazureb2c.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.nextjsandazureb2c.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.nextjsandazureb2c.localhost"
