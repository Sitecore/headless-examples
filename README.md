...
* Sitecore reserves the right to decline examples, but don't let this discourage you. Submit issues or inquire on the [#headless Slack channel](https://sitecorechat.slack.com/archives/C7JT0NRQW) of the [Sitecore Community Slack](https://sitecore.chat/) if you want to validate an idea first.
